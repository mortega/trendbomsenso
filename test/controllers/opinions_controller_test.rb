...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { message: @opinion.message, name: @opinion.name, subject_id: @opinion.subject_id }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { message: @opinion.message, name: @opinion.name, subject_id: @opinion.subject_id }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
